...
contract('SupplyChain', function(accounts) {
    ...
    const productPrice = web3.utils.toWei(web3.utils.toBN(0), "ether")
    var itemState = 0
    ...
    it("Testing smart contract function harvestItem() that allows a farmer to harvest coffee", async() => {
        ...
        assert.equal(resultBufferTwo[4].toString(), productPrice.toString(), 'Error: Invalid product price')
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        await supplyChain.buyItem(upc, {value:web3.utils.toWei(web3.utils.toBN(2), "ether")});  
    ...
    it("Testing smart contract function fetchItemBufferTwo() that allows anyone to fetch item details from blockchain", async() => {
        ...
        assert.equal(resultBufferTwo[4].toString(), productPrice.toString(), 'Error: Invalid product price')
        assert.equal(resultBufferTwo[5], 7, 'Error: Invalid item state')
        assert.equal(resultBufferTwo[6], ownerID, 'Error: Invalid Distributor ID')
        assert.equal(resultBufferTwo[7], ownerID, 'Error:Invalid Retailer ID')

...
contract SupplyChain is DistributorRole, ConsumerRole, RetailerRole, FarmerRole, Ownable{
  ...
  modifier checkValueDist(uint _upc) {
    _;
 ...
 /* function kill() public {
  ...
  function harvestItem(uint _upc, address _originFarmerID, string _originFarmName, string _originFarmInformation, string  _originFarmLatitude, string  _originFarmLongitude, string  _productNotes) public onlyFarmer()
  {
    ...
    Item memory newItem = Item(sku, _upc, Ownable.owner(), _originFarmerID, _originFarmName, _originFarmInformation, _originFarmLatitude, _originFarmLongitude, sku+_upc, _productNotes, 0, defaultState, msg.sender, msg.sender, msg.sender);
    items[_upc] = newItem;
    //console.log(newItem);
